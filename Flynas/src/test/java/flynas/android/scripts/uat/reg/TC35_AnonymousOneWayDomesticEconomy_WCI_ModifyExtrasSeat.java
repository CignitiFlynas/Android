...
public class TC35_AnonymousOneWayDomesticEconomy_WCI_ModifyExtrasSeat extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestData_UAT_Reg"),"FL_WEB_35");

	@Test(dataProvider = "testData",groups={"Android"})
	public void TC_35_AnonymousOneWayDomesticEconomy_WCI_ModifyExtrasSeat(String tripType, String origin, String dest, 
			...
			String charity,String currency,String description)throws Throwable{
				try{
					...
					Reporter.SuccessReport("TC35_AnonymousOneWayDomesticEconomy_WCI_ModifyExtrasSeat", "Pass");
					
					}catch(Exception e){
						e.printStackTrace();
						Reporter.failureReport("TC35_AnonymousOneWayDomesticEconomy_WCI_ModifyExtrasSeat", "Fail");
