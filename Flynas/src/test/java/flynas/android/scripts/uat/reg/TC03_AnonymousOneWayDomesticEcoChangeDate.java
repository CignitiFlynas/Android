...
public class TC03_AnonymousOneWayDomesticEcoChangeDate extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataForAndroid"),"TC_03_oneWayDomesticChangeDate");

	@Test(dataProvider = "testData",groups={"Android"})
	public  void TC_03_AnonymousOneWayDomesticEcoChangeDate(String tripType, String origin, String dest, 
		...
		try {
			...
			Reporter.SuccessReport("TC03_AnonymousOneWayDomesticEcoChangeDate", "Pass");
			}
			else{
				Reporter.failureReport("TC03_AnonymousOneWayDomesticEcoChangeDate", "PNR Did not match");
			}
		}
